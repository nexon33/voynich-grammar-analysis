"""
Phase 6C: Re-translation with 9 VALIDATED NOUNS
...
9. teo - pharmaceutical term (pharmaceutical-enriched) (NEW!)
...
def translate_word_phase6c(word):
    """Translate with 9 validated nouns + complete grammar"""
    ...
    if remainder.startswith("shee"):
        ...
        translations.append("TEO")  # NEW pharmaceutical term!
        remainder = remainder[3:]
...
def translate_sentence(sentence):
    ...
    return " ".join([translate_word_phase6c(w) for w in words])
...
test_sentences = [
    ...
    ("f2r", "herbal", "dain os teody"),  # NEW: has TEO!
    ...
    ("f88v", "pharmaceutical", "yteody qokeeodal"),  # NEW: has TEO!
    ("f67r2", "astronomical", "chocfhy saral"),
]

print("=" * 70)
print("PHASE 6C: RE-TRANSLATION WITH 9 VALIDATED NOUNS")
print("=" * 70)
...
for folio, section, sentence in test_sentences:
    ...
    if is_coh:
        print("Coherent: YES ✓✓✓")
        print("Why coherent:")
        print("  ✓ Has semantic content (botanical/pharmaceutical/concrete terms)")
...
print("Phase 6B (8 nouns + grammar):         8/8 coherent (100%)")
print(
    f"Phase 6C (9 nouns + grammar):         {coherent_count}/{len(test_sentences)} coherent ({100 * coherent_count / len(test_sentences):.0f}%)"
)

if coherent_count >= 9:
    print("\n✓✓✓ EXCELLENT PROGRESS")
    print('Adding "teo" (pharmaceutical) improved translation!')
    print("Pharmaceutical section recognition improving!")
else:
    print("\n✓✓ GOOD PROGRESS")
    print("Continue expanding vocabulary.")

print(f"\n{'=' * 70}")
print("PHARMACEUTICAL VOCABULARY PROGRESS")
print("=" * 70)
print("Pharmaceutical-specific terms identified:")
print("  1. red (dor) - universal/pharmaceutical")
print("  2. KEO (keo) - pharmaceutical-enriched (48.5%)")
print("  3. TEO (teo) - pharmaceutical-enriched (52.7%) ← NEW!")
print("\n→ Pharmaceutical section now has 3 domain-specific terms!")

print(f"\n{'=' * 70}")
print("NEXT STEPS")
print("=" * 70)
print("1. Validate 1-3 more candidates to reach 10-12 nouns")
print("2. Focus on herbal section (still highest word count)")
print("3. Target: 12-15 validated nouns for publication")
